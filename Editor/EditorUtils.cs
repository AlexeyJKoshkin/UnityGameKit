...
namespace GameKit.Editor
{
    ...
    {
        private static readonly Dictionary<Type, Func<string, string>> _pathNormalizer =
        ...
        /// <returns></returns>
        public static T MouseEventHandlerHelper<T>(Rect dropArea, Object previewObject, Action onDelete = null)
            where T : Object
        {
            ...
            switch (evt.type)
            {
                ...
                case EventType.MouseDown:
                    if (dropArea.Contains(evt.mousePosition)) EditorGUIUtility.PingObject(previewObject);
        ...
        /// <summary>
        /// Создаем новую сцену с вопросом о сохранении
        /// </summary>
