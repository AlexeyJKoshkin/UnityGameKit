...
public static class SerializedPropertyExtensions
{
    ...
    public static bool SetValue<T>(this SerializedProperty property, T value)
    {
        ...
        return SetFieldOrPropertyValue(fieldName, obj, value, value.GetType().IsArray);
    }
    ...
    {
        foreach (string part in path.Split('.')) obj = GetFieldOrPropertyValue<object>(part, obj, includeAllBases);
        return (T) obj;
    }
